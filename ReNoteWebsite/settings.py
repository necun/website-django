"""
Django settings for ReNoteWebsite project.
...
#         'DIRS': [BASE_DIR / 'pages' / 'templates'],  # Specify the path correctly
#         'APP_DIRS': True,
#         'OPTIONS': {
#             'context_processors': [
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                'django.template.context_processors.debug',
                'django.template.context_processors.request',  # Required for {% url %} tag
                'django.contrib.auth.context_processors.auth',
                'django.contrib.messages.context_processors.messages',
            ],
        },
...
WSGI_APPLICATION = "ReNoteWebsite.wsgi.application"
